        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    result = [];
                    rows = this.database.db.prepare('SELECT [Id], [Name], [LocationId], [DefaultHostName], [SerialNumber], [Notes], [SerialNumber], [CreatedDate], [UpdatedDate], [ManufacturerId], [ProductId] FROM Devices').all();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    result = [];
                    rows = this.database.db.prepare('SELECT [Id], [Name], [LocationId], [DefaultHostName], [SerialNumber], [Notes], [SerialNumber], [CreatedDate], [UpdatedDate], [ManufacturerId], [ProductId] FROM [Devices] WHERE [ProductId] = ?').all(productId);
                    for (i = 0; i < rows.length; i++) {
                        result.push(new models_1.Device(rows[i]));
                    }
                    return [2 /*return*/, result];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    result = [];
                    rows = this.database.db.prepare('SELECT [Id], [Name], [LocationId], [DefaultHostName], [SerialNumber], [Notes], [SerialNumber], [CreatedDate], [UpdatedDate], [ManufacturerId], [ProductId] FROM [Devices] WHERE [LocationId] = ?').all(locationId);
                    for (i = 0; i < rows.length; i++) {
                        result.push(new models_1.Device(rows[i]));
                    }
                    return [2 /*return*/, result];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    result = [];
                    rows = this.database.db.prepare('SELECT [Id], [Name], [LocationId], [DefaultHostName], [SerialNumber], [Notes], [SerialNumber], [CreatedDate], [UpdatedDate], [ManufacturerId], [ProductId] FROM [Devices] WHERE [ManufacturerId] = ?').all(manufacturerId);
                    for (i = 0; i < rows.length; i++) {
                        result.push(new models_1.Device(rows[i]));
                    }
                    return [2 /*return*/, result];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                try {
                    ...
                    row = this.database.db.prepare('SELECT [Id], [Name], [LocationId], [DefaultHostName], [SerialNumber], [Notes], [CreatedDate], [UpdatedDate], [ManufacturerId], [ProductId] FROM Devices WHERE [Id] = ?').get(id);
            ...
            return tslib_1.__generator(this, function (_a) {
                try {
                    if (obj.Id) {
                        ...
                        result = this.database.db.prepare('SELECT [Id], [Name], [LocationId], [DefaultHostName], [SerialNumber], [Notes], [CreatedDate], [UpdatedDate], [ManufacturerId], [ProductId] FROM [Devices] ORDER BY [Id] DESC LIMIT 1').get();
