...
var ProductController = /** @class */ (function (_super) {
    ...
    function ProductController(logger, settings, database, repository) {
        ...
        _this.list = function (req, res) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var manufacturerId, result, err_2;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, this.repository.list(manufacturerId)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, this.json(res, result)];
                    case 2:
        ...
        _this.save = function (req, res) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var obj, result, err_4;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        this.logger.debug('Received request for product save');
                        obj = new models_1.Product(req.body);
    ...
    ProductController = tslib_1.__decorate([
        ...
        tslib_1.__param(3, inversify_1.inject('productRepository')),
        tslib_1.__metadata("design:paramtypes", [Object, Object, Object, repositories_1.ProductRepository])
    ], ProductController);
