...
var FieldController = /** @class */ (function (_super) {
    tslib_1.__extends(FieldController, _super);
    function FieldController(logger, settings, database, repository) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        obj = new models_1.Field(req.body);
    ...
    FieldController = tslib_1.__decorate([
        ...
        tslib_1.__param(3, inversify_1.inject('fieldRepository')),
        tslib_1.__metadata("design:paramtypes", [Object, Object, Object, repositories_1.FieldRepository])
    ], FieldController);
